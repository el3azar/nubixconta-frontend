...
const TableBank = ({ doc, columns, actionsProps, styles, showRowActions, disableGenericActions }) => {
...
export const DocumentTableBank = ({ documents, isLoading, isError, error, actionsProps, styles, columns, showRowActions, emptyMessage, disableGenericActions }) => {
