...
export const DocumentTable = ({ documents, isLoading, isError, error, actionsProps, styles, columns, showRowActions, emptyMessage }) => {
  ...
  return documents.map((doc, index) => (
    <DocumentTableRow
      // Usamos un ID de la BD si existe, si no, usamos el índice (para asientos nuevos)
      key={doc.idPurchase || doc.idNotaCredit || doc.saleId || doc.idPurchaseCreditNote || doc.idBankTransaction || doc.idBankEntry || index}
      doc={doc}
