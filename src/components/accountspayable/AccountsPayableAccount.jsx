...
import { getAccountStatementsBySupplier } from "../../services/accountspayable/accountPayableSupplierService";
import { getBankAcount } from "../../services/accountsreceivable/bankService";
import BankAccountModal from "../accountsreceivable/BankAccountModal";
...
const AccountsPayableAccount = () => {
  ...
  const handleSearch = async () => {
    const results = await getAccountStatementsBySupplier(filters);
  ...
  return (
    ...
    <section className={styles.container}>
      <h2 className={styles.titulo}>ESTADO DE CUENTA POR PROVEEDOR</h2>

      <div className={styles.seccionSuperior}>
        <div className={styles.bloqueFiltros}>
          <h4 className={styles.subtitulo}>Buscar Proveedor</h4>
...
export default AccountsPayableAccount;